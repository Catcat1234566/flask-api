...
CORS(app, resources={
    r"/*": {
        "origins": ["http://10.199.34.34:3000","http://10.199.34.75:3000","http://10.199.34.44:3000"],  # อนุญาตแค่ Frontend
...
def not_found(e):
    return jsonify({
        "msg": "ไม่รู้จัก Route ที่เรียกใช้ครับ",
        "code": 404
    }), 404
